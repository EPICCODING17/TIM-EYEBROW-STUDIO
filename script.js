...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const serviceData = {
    "Hairstroke": {
      ...
      title_th: "การสักคิ้ว Hairstroke",
      title_en: "Hairstroke Eyebrow Tattoo",
      splitKey: "Hairstroke Eyebrow Tattoo",
      splitMode: "th_first",
...
• Aftercare: Even though it’s a closed wound technique, proper aftercare—such as maintaining cleanliness and avoiding scab-picking—is essential for long-lasting, beautiful results.`,
    ...
    "Shading": {
      ...
      title_th: "การสักคิ้ว Shading / Ombre Brows",
      title_en: "Shading / Ombre Brows",
      splitKey: "💫 What is Shading Brows?",
      splitMode: "th_first",
...
🩷 Benefits
    ...
    "Lips": {
      ...
      title_th: "ฝังสีปาก Soft Lips",
      title_en: "Soft Lips Pigmentation",
      splitKey: "Soft Lips Pigmentation",
      splitMode: "th_first",
...
• Boosts confidence by eliminating concerns about lip discoloration and enhancing your smile.`,
    ...
    "Eyeliner": {
      ...
      title_th: "สักตา Eyeliner",
      title_en: "Eyeliner Tattoo",
      splitKey: "Eyeliner Tattoo",
      splitMode: "th_first",
...
• Confidence: Provides a polished appearance even without makeup.`,
    ...
    "Inner-liner": {
      ...
      title_th: "การสักตา Inner liner",
      title_en: "Inner Liner Tattoo",
      splitKey: "Inner Liner Tattoo",
      splitMode: "th_first",
...
• Confidence: Provides a naturally beautiful appearance at all times.`,
    ...
    "Soft liner": {
      ...
      title_th: "การสักตา Soft liner",
      title_en: "Soft-Liner Tattoo",
      splitKey: "Soft-Liner Tattoo",
      splitMode: "th_first",
...
• Confidence: Ensures a perfect, smudge-proof makeup look 24/7.`,
    ...
    "Labina": {
      ...
      title_th: "น้ำหมึกพิกเมนต์ LaBina® จากประเทศเยอรมนี",
      title_en: "LaBina® Pigment Inks from Germany",
      splitKey: "---",
      splitMode: "en_first",
...
น้ำหมึกพิกเมนต์ LaBina® ผลิตขึ้นจากวัตถุดิบคุณภาพสูงสุดและผ่านกระบวนการที่พิถีพิถัน บริษัท PERMANENT-Line ให้ความสำคัญกับความปลอดภัย การใช้ส่วนผสมที่ก่อการแพ้น้อย และความโปร่งใสมาโดยตลอด โดยมีการเผยแพร่ผลการวิเคราะห์อย่างละเอียดสำหรับทุกล็อตของสีพิกเมนต์ ใบรับรองเหล่านี้จะจัดส่งให้ผู้ใช้งานพร้อมกับสีในทุกการสั่งซื้อ และยังสามารถส่งต่อให้ผู้บริโภคปลายทางได้ผ่านทาง QR Code ที่พิมพ์อยู่บนใบรับรองด้วย`,
    ...
    "Mara Pro": {
      ...
      title_th: "สีสัก MARA Pro จากประเทศสหรัฐอเมริกา",
      title_en: "MARA Pro / MARA Colors (USA)",
      splitKey: "---",
      splitMode: "en_first",
...
• อุปกรณ์เข็ม / แคร์ทริดจ์ (needle cartridges) ของ MARA Pro ก็มีจำหน่าย พร้อมคุณสมบัติต่าง ๆ เช่น ระบบกันการย้อนกลับของหมึก (ink spit-back membrane) และออกแบบมาให้แม่นยำและอ่อนโยนสำหรับผิวหน้า`,
    ...
    "Xion S": {
      ...
      title_th: "อุปกรณ์เครื่องสัก Spektra Xion S",
      title_en: "Spektra Xion S Machine",
      splitKey: "เครื่องสัก Xion S (Spektra Xion S)",
      splitMode: "en_first",
...
• คู่มือผู้ใช้`,
    ...
    "Vertix": {
      ...
      title_th: "เข็มสัก Vertix Needle พรีเมียมเกรด",
      title_en: "Vertix Needle Premium Grade",
      splitKey: "คุณสมบัติเด่นของเข็มสัก Vertix",
      splitMode: "en_first",
...
<div class="flex flex-wrap gap-4 mt-6">
  ...
  <a href="https://www.fkirons.com/collections/vertix?utm_source=chatgpt.com" target="_blank" class="btn-outline px-6 py-2 text-sm rounded-full flex items-center gap-2 transition-all">FK Irons</a>
    ...
    "Etalon Mix": {
      ...
      title_th: "น้ำยาลบรอยสัก Etalon Mix Remover",
      title_en: "Etalon Mix Remover",
      splitKey: "ผลิตภัณฑ์ Etalon Mix Remover",
      splitMode: "en_first",
...
ผลิตภัณฑ์ Etalon Mix Remover เหมาะสำหรับใช้โดยผู้เชี่ยวชาญเท่านั้น หลังจากผ่านการอบรมคอร์สแล้วจึงจะสามารถใช้งานได้อย่างถูกต้อง คุณสามารถใช้รีมูฟเวอร์นี้ระหว่างการฝังสีเพื่อแก้ไขข้อบกพร่อง หรือเพื่อลดความเข้มของงานสักถาวร (PMU) ที่ไม่สวยงามได้ โดยไม่ก่อให้เกิดผลกระทบด้านลบ`,
  ...
  serviceLinks.forEach(link => {
    link.addEventListener('click', (e) => {
      ...
      if (serviceKey && mainContent && serviceDetailView) {
        ...
        // Compute bilingual descriptions using splitKey or explicit fields
        let _desc_th, _desc_en;
        if (data.desc_th && data.desc_en) {
          _desc_th = data.desc_th;
          _desc_en = data.desc_en;
        } else if (data.splitKey && data.description) {
          const _idx = data.description.indexOf(data.splitKey);
          if (_idx !== -1) {
            if (data.splitMode === 'en_first') {
              _desc_en = data.description.substring(0, _idx).trim();
              _desc_th = data.description.substring(_idx).trim();
            } else {
              _desc_th = data.description.substring(0, _idx).trim();
              _desc_en = data.description.substring(_idx).trim();
            }
          } else { _desc_th = _desc_en = data.description; }
        } else { _desc_th = _desc_en = data.description || ''; }
        // Set bilingual attributes for language toggle
        serviceDetailTitle.setAttribute('data-th', data.title_th || data.title);
        serviceDetailTitle.setAttribute('data-en', data.title_en || data.title);
        serviceDetailDesc.setAttribute('data-th', _desc_th);
        serviceDetailDesc.setAttribute('data-en', _desc_en);
        // Apply current language immediately
        if (window.applyLanguage) window.applyLanguage(window.currentLanguage);
  ...
  if (window.applyLanguage) {
    window.applyLanguage(window.currentLanguage);
  }
});
...
/* ===============================================
   ...
   =============================================== */
window.currentLanguage = localStorage.getItem("site_lang") || "th";
...
window.applyLanguage = function(lang) {
  ...
  document.title = lang === "th"
    ? "TIM EYEBROW STUDIO | ผู้เชี่ยวชาญ Permanent Makeup กรุงเทพ"
    : "TIM EYEBROW STUDIO | Premium Permanent Makeup Bangkok";

  // Update buttons display
  document.querySelectorAll(".current-lang-display").forEach(el => {
    el.textContent = lang === "th" ? "TH" : "EN";
  });

  // Swap texts across elements with data-th and data-en
  document.querySelectorAll("[data-th][data-en]").forEach(el => {
    if (el.tagName === "INPUT" || el.tagName === "TEXTAREA") {
      el.placeholder = el.getAttribute("data-" + lang);
    } else {
      // Use innerHTML so we can include icons or strong tags if needed
...
window.toggleLanguage = function() {
  const newLang = window.currentLanguage === "th" ? "en" : "th";
